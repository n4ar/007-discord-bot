import type * as Lavalink from "@liliaclient/types";
import type { Manager, Dictionary, Plugin } from "liliaclient";
...
export class SpotifyManager {
    ...
    constructor(liliaclient: Manager, options: SpotifyManagerOptions);
